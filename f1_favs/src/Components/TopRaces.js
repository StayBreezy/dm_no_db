...
export default class TopRaces extends Component {
    ...
    handleClick = (race) => {
        ...
        axios.put(`/api/favorites/${race.id}`, race)
        .then(res => {
    ...
    render() {
    let iconX = <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-square-x" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
